 ...
 *
 * На вход идут либо строки из распознавания (assets/ocr.js), либо текст,
 * вставленный человеком. Разница одна, но важная: распознавание знает, где на
 * бумаге были широкие пробелы между колонками, и отмечает их табуляцией.
 *
